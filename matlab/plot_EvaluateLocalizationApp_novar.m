...
for i = 1:length(instances)
    ...
    % =================== parse the vemu file ===================
    vemu_path = ['../results/localization_novar_vemu/' inst '_' state];
    ...
    % ==================== parse the app file ===================
    app_path = ['../results/localization_novar_app/' inst '_' state];
...
%% Save the results
fstring = sprintf('loc_errors_novar_%d',IDX);
...
%saveplot('../tecs/figures/localization_novar');
...
saveplot('../tecs/figures/localization_variance_novar');
