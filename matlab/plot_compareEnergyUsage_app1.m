...
subaxis(1,3,1,'Margin', 0.04, 'MarginBottom',0.2,'Padding',0);
inst = 1;
...
ylim([-8 8]);
xlim([10e-4 2e-1]);
xlabel('Target Duty Cycle (Inst: BC)','FontSize',14);
ylabel('Error in Energy Cons. (%)','FontSize',14);
legend('T: mild','T: medium','T: harsh','Location','NorthEast');
semilogx([10e-4 2e-1],[0 0],'k','LineWidth',2);
grid on;


subaxis(1,3,2,'Margin', 0.04, 'MarginBottom',0.2,'Padding',0);
inst = 2;
semilogx(dutycycles,reshape(errors(inst,1,:),1,5),...
    'o-r','MarkerSize',10,'LineWidth',2);
hold on;
...
ylim([-8 8]);
xlim([10e-4 2e-1]);
xlabel('Target Duty Cycle (Inst: NC)','FontSize',14);
ylabel('Error in Energy Cons. (%)','FontSize',14);
legend('T: mild','T: medium','T: harsh','Location','NorthEast');
semilogx([10e-4 2e-1],[0 0],'k','LineWidth',2);
grid on;
...
subaxis(1,3,3,'Margin', 0.04, 'MarginBottom',0.2,'Padding',0);
inst = 3;
semilogx(dutycycles,reshape(errors(inst,1,:),1,5),...
    'o-r','MarkerSize',10,'LineWidth',2);
hold on;
...
ylim([-8 8]);
xlim([10e-4 2e-1]);
xlabel('Target Duty Cycle (Inst: WC)','FontSize',14);
ylabel('Error in Energy Cons. (%)','FontSize',14);
legend('T: mild','T: medium','T: harsh','Location','NorthEast');
semilogx([10e-4 2e-1],[0 0],'k','LineWidth',2);
grid on;
...
%saveplot('../tecs/figures/app1_nonoise');
