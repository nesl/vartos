...
/* Example empty task */
static void vHookSensor1( void *pvParameters );
static void vHookSensor2( void *pvParameters );
...
xTaskHandle handleSensor1;
xTaskHandle handleSensor2;
...
#ifdef USE_VARTOS
portKNOB_TYPE sensor_knob1;
portKNOB_TYPE sensor_knob2;
#else
...
int main( void )
{
    ...
    // Generic tasks
	xTaskCreate( vHookSensor1, "Task1", configMINIMAL_STACK_SIZE, NULL, mainTASK_PRIORITY, &handleSensor1, &sensor_knob2, 1, 5, 1);
	xTaskCreate( vHookSensor2, "Task2", configMINIMAL_STACK_SIZE, NULL, mainTASK_PRIORITY, &handleSensor2, &sensor_knob1, 1, 5, 1);
    #else
...
portTickType xLastExecutionTime = xTaskGetTickCount();
   	...
   	for( ;; )
	{
		...
		vTaskDelayUntil( &xLastExecutionTime, SENSOR1_DELAY );
        ...
        switch(sensor_knob1){
            ...
            case 2:
                ...
                break;
            case 3:
                iters = 20000+5000+10000;
                break;
            case 4:
                iters = 20000+5000+10000+25000;
                break;
            case 5:
                iters = 20000+5000+10000+25000+6000;
                break;
            default:
                iters = 1;
                break;
...
static void vHookSensor2( void *pvParameters )
{
	...
	{
		/* Enforce task frequency */
		vTaskDelayUntil( &xLastExecutionTime, SENSOR2_DELAY );
        ...
        switch(sensor_knob2){
            ...
            case 2:
                ...
                break;
            case 3:
                iters = 14000+9000+15000;
                break;
            case 4:
                iters = 14000+9000+15000+24000;
                break;
            case 5:
                iters = 14000+9000+15000+24000+8000;
                break;
            default:
                iters = 1;
                break;
