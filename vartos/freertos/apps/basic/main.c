...
static void vHookTask2( void *pvParameters )
{
	...
	for( ;; )
	{
        ...
        */
        ...
        uputs("Test message: ");
        uputi( (vGetTimerValue() - old_time) );
        //uputi( ( (unsigned int)vGetTimerValue())/1000  );
        //uputi( (uint32_t)*((uint32_t*)(0x40032048)) );
        //uputi( (uint32_t)(0b11111111111111111111111111111111) );
        uputs("\n");
        old_time = vGetTimerValue();
