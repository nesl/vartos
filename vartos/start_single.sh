...
../varemu/qemu-linaro/arm-softmmu/qemu-system-arm -M lm3s6965evb -kernel $4 -singlestep -variability $if --serial stdio -temperature $wf -vlog ../results/sandbox_vemu/$lfile -vextra $extra_param > ../results/sandbox_app/$lfile
